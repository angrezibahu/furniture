...
export const products: Product[] = [
  ...
  },
  {
    ...
    badge: "New",
    colors: ["#8B7E74", "#2C2C2C", "#D4A59A"],
    description: "The perfect reading companion. The Jordan Armchair wraps you in comfort with its generously proportioned seat and supportive backrest.",
    features: [
      "Generous seat depth",
